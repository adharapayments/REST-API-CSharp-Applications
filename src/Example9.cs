...
class Example9
{
    ...
    public static void Main9(string[] args)
    {
        ...
        List<AdharaHFT.orderTick> orderTickList1 = wrapper.getOrder(null, null, new List<string> { AdharaHFT.ORDERTYPE_PENDING });
        ...
        List<AdharaHFT.orderTick> orderTickList2 = wrapper.getOrder(null, null, new List<string> { AdharaHFT.ORDERTYPE_PENDING });
        ...
        List<AdharaHFT.orderTick> orderTickList3 = wrapper.getOrder(null, null, new List<string> { AdharaHFT.ORDERTYPE_PENDING });
